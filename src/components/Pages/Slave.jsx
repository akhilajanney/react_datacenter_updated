...
registerSlave=()=>{
    ...
    if($('#slaveregid').val().length===0){
        $('#text').hide().html("Slave Gateway ID must be filled out").fadeIn('slow');
        setTimeout(function() {
           $('#text').hide();
        }, 3000);
     }
...
removeSlave=()=>{
    ...
    if ($('#slaveremv').val().length===0) {
        ...
        axios({
           method: "DELETE", url: slave_register,
           data:data
        })
           .then((response) => {
              console.log(response);
...
remove=()=>{
    document.getElementById("removeslave").style.display = $("#removeslave").css("display") === 'block' ? 'none' : 'block'
}
  render() {
              ...
              <strong>{message}</strong>
                      ...
                      <div>
                        ...
                        <div className="inputdiv">
                            ...
                            <input type="text" name="id" id="slaveregid" required="required" placeholder='5a-c2-15-0a-00-00'
                            />
                        </div>
                        ...
                        <div className='register' style={{width:'170px',marginLeft:'17px'}}>
                                <div onClick={this.registerSlave}
                            ...
                            <div id='removeslave' style={{marginTop:'40px',display:'none'}}>
                                    <div className="inputdiv">
                                    <span className="label">Slave Gateway ID :</span>
                                    <input type="text" name="id" id="slaveremv" required="required" 
                                    />
                                    <div className='remove'  style={{width:'170px',marginLeft:'225px'}}>
                                <div onClick={this.removeSlave}
