...
export default class Master extends Component {
    ...
    componentDidMount(){
          axios({
              method:'GET',url:upload_floormap
          })
          .then((response)=>{
    ...
    registerMaster=()=>{
        ...
        if($('#masterregid').val().length===0){
            $('#text').hide().html("Master Gateway ID must be filled out").fadeIn('slow');
            setTimeout(function() {
               $('#text').hide();
            }, 3000);
         }
    ...
    removeMaster=()=>{
        ...
        if ($('#masterremv').val().length===0) {
            ...
            axios({
               method: "DELETE", url: master_register,
               data:data
            })
               .then((response) => {
                  console.log(response);
    ...
    remove=()=>{
        document.getElementById("removemaster").style.display = $("#removemaster").css("display") === 'block' ? 'none' : 'block'
    }
  render() {
    ...
    return (
      <div>
         ...
         <div style={{marginTop:'30px',justifyContent:'space-between'}}>
            <b> <p id='text' style={{color:'red'}}></p></b>
         {error && (
              ...
              <strong>{message}</strong>
                      ...
                      <div>
                        ...
                        <div className="inputdiv">
                            ...
                            <input type="text" name="id" id="masterregid" required="required" placeholder='5a-c2-15-00-00-00'
                            />
                        </div>


                        <div style={{display:'flex',width:'85%'}}>
                        <div className='register' style={{width:'170px',marginLeft:'17px'}}>
                                <div onClick={this.registerMaster}
                            ...
                            <div className='remove' onClick={this.remove} style={{width:'170px',marginLeft:'60px'}}>
                                <div 
                            ...
                            <div id='removemaster' style={{marginTop:'40px',display:'none'}}>
                                    <div className="inputdiv">
                                    <span className="label">Master Gateway ID :</span>
                                    <input type="text" name="id" id="masterremv" required="required" 
                                    />
                                    <div className='remove'  style={{width:'170px',marginLeft:'225px'}}>
                                <div onClick={this.removeMaster}
